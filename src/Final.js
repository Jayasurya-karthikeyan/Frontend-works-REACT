...
const data = [
  ...
  [
    "https://i.pinimg.com/originals/44/2a/1a/442a1a4457337aaa24bdffcb6d46808a.png",
    "Top Damager",
    "7850",
    "1000",
  ],
  ...
  return (
    <div className="participants container py-4">
      <div className="border border-3 border-white ">
        <div classname="py-3">
          <p className="mx-4 mt-2 fw-bold h2">Final Winners</p>
          <div className="d-flex row justify-content-between mx-3 mb-3">
            ...
            <div className="pt-4 row col-12 col-lg-6 ps-lg-3 row d-flex align-items-evenly justify-content-around">
              {buttons.map((button) => (
          ...
          <div className="col-12 mb-3">
            ...
            <Button className="mx-2" variant="contained" color="warning">
              Special prices
            </Button>
          </div>
        </div>
        ...
        >
          {data.map((data,index) => (
            <div className="col-10 col-sm-6 col-lg-4 col-xl-3 p-3">
              <Box
                className="text-center bg-primary p-3 text-center"
                style={{ height:300,borderRadius: 30 }}
              >
                <div className="h4 text-white fw-bold mb-3">Rank {index+1}</div>
                <img
                  src={data[0]}
                  // width="100%"
                  height="60%"
                ...
                <div className="d-flex my-3 mx-2 justify-content-between">
                  <div className="col-4">Score: {data[2]}</div>
                  <div className="col-4">Price: {data[3]}</div>
