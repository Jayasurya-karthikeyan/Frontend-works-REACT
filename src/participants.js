  ...
  return (
    <div className="participants container py-3">
      ...
      <div className="d-flex">
        <p className="p-3 col-12 col-md-8">
        ...
        <div className="p-3 col-6 col-md-2">
          <FormControl
            variant="filled"
            sx={{ m: 1, minWidth: "10vw", color: "white" }}
          >
            <InputLabel className="fw-bold">Bulk Actions</InputLabel>
            <Select
        ...
        <div className="p-3 col-6 col-md-2">
          <FormControl variant="filled" sx={{ m: 1, minWidth: "10vw" }}>
            <InputLabel className="fw-bold">Sort By</InputLabel>
            <Select
              labelId="demo-simple-select-filled-label"
              id="demo-simple-select-filled"
            >
      ...
      {isPart ? (
        ...
        <div className="d-lex align-item-center">
          <Card className="col-6" sx={{ minWidth: 275 }}>
            <CardContent>
              <Typography
